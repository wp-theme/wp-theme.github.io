...
<CardGrid>
  <Card title="Just-Blade" icon="seti:babel" link="/just-blade/">
  ...
  <Card title="WP-Blade" icon="seti:sbt" link="/wp-blade/">
  ...
  <Card title="WP-Theme" icon="seti:bower" link="/wp-theme/">
  ...
  <Card title="WP-Plugin" icon="puzzle">
